...
- Build and manage cloud infrastructure on AWS (EC2, VPC, IAM, EKS)
- Design CI/CD pipelines using Jenkins and GitHub Actions
- Containerise applications using Docker and Kubernetes
- Monitor systems with CloudWatch, Prometheus and Grafana
...
**Other**
- Linux, Networking (TCP/IP), Terraform (basic)
...
- Improving Kubernetes and production-level deployments
- Learning Infrastructure as Code (Terraform deeper)
